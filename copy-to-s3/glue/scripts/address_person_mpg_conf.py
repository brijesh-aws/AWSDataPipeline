...
filePath = "s3://{}/data/address_person_mpg".format( confBucketName )
...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = curratedDB, table_name = "address_person_mpg", transformation_ctx = "datasource0")
...
sink.setFormat("json")
sink.setCatalogInfo( catalogDatabase = confDB, catalogTableName="address_person_mpg" )
