...
filePath = "s3://{}/currated/address_person_mpg".format( currBucketName )
...
datasource0 = glueContext.create_dynamic_frame.from_catalog( database = rawDB, table_name = "address_person_mpg", transformation_ctx = "datasource0" )
...
sink.setFormat("json")
sink.setCatalogInfo( catalogDatabase = curratedDB, catalogTableName = "address_person_mpg" )
